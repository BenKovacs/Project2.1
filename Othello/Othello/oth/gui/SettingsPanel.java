...
public class SettingsPanel extends JPanel {
		...
		public SettingsPanel() {
			...
			sl_contentPanel.putConstraint(SpringLayout.NORTH, lblBoardSiye, 10, SpringLayout.NORTH, this);
			sl_contentPanel.putConstraint(SpringLayout.WEST, lblBoardSiye, 10, SpringLayout.WEST, this);
			this.add(lblBoardSiye);
