...
import model.data_model.TestingPanel;
import model.player.*;
import javax.swing.*;
import java.awt.*;
...
public class TestAppV2{
	...
	private static TestAppV2 testAppV2;

	public static TestAppV2 getSingleton() {
		return testAppV2;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TestAppV2 window = new TestAppV2();
	...
	private void initialize() {
		...
		boardPanel = new TestingPanel(gameBoard, rPanel);
